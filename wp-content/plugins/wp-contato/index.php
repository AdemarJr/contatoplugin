...
add_shortcode( 'listpessoas', 'wpcvf_listpessoas' );
...
function wpcvf_lista_pessoas_admin() {
...
function wpcvf_carregar_bairro(){
	...
	$sqlBairro = "SELECT bairro FROM ".$wpdb->prefix."wls_pessoas where pais = '".$estado."' and cidade = '".$cidade."' group by bairro";
